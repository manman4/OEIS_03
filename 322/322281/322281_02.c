                              ...
                              bool use_symmetry)
{
    ...
    Count128 count = map_get_count(map, slot);
    return use_symmetry ? count_halve(count) : count;
}
                                 ...
                                 bool use_symmetry, size_t *result_count)
{
    ...
    uint64_t *sets = malloc(checked_product_size(allocation_capacity,
                                                 sizeof(*sets)));
    if (sets == NULL) die("out of memory collecting split subsets");
    size_t count = 0;
                            ...
                            bool use_symmetry, MitmStats *stats)
{
    ...
    size_t allocation_n = n == 0 ? 1U : (size_t)n;
    Count128 *right = calloc(allocation_n3, sizeof(*right));
    Count128 *right_de = calloc(allocation_n2, sizeof(*right_de));
    Count128 *q = calloc(allocation_n2, sizeof(*q));
    Count128 *q_row = calloc(allocation_n, sizeof(*q_row));
    Count128 *h = calloc(allocation_n, sizeof(*h));
