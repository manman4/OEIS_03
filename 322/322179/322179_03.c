/*
 * A322179 -- out-of-core ranked-layer DP.
 *
 ...
 *
 * Unlike 322179_01.c, layer arrays are temporary file-backed mmap regions.
 ...
 *       322179_03.c -o 322179_03
 *
 * Usage:
 *   ./322179_03 --term 16
 *   ./322179_03 16
 *   ./322179_03 --check
 *   ./322179_03 --term 16 --work-dir /path/with/free/space
 * Results are atomically recorded in b322179_03.txt by default.  Use
...
#error "322179_03.c requires unsigned __int128"
#endif
...
static const char *output_path = "b322179_03.txt";
...
static void store_bfile_term(int n, U128 value)
{
    ...
    free(temporary);
    fprintf(stderr, "322179_03: updated %s through n=%d\n",
            output_path, n);
}
...
static void check_disk_space(unsigned positions)
{
    ...
    fprintf(stderr,
            "322179_03: peak temporary disk %.2f GiB; available %.2f GiB\n",
...
static Layer make_layer(unsigned positions, unsigned occupied)
{
    ...
    const char suffix[] = "/.322179_03_layer_XXXXXX";
...
static U128 a322179(int n)
{
    ...
    for (unsigned placed = 0; placed < (unsigned)n; ++placed) {
        ...
        current = next;
        fprintf(stderr,
                "322179_03: n=%d, label=%d, states=%" PRIu64
                ", transitions=%" PRIu64
