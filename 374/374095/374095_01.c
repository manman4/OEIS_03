/*
 * A374095: least nonnegative k having exactly n solutions of
 *
 ...
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 374095_01.c \
 *       -o 374095_01 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./374095_01 --target 10 --verbose
 *   ./374095_01 --upto 100
 *   ./374095_01 --self-test 1000000
 */
...
#define BFILE_NAME "b374095.txt"
#define BFILE_TEMP_NAME "b374095.txt.tmp"
