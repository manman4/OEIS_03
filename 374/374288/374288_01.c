 ...
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 374288_01.c \
 *       -o 374288_01 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./374288_01 --target 23 --verbose
 *   ./374288_01 --upto 100
 *   ./374288_01 --self-test 1000000
 */
...
#define BFILE_NAME "b374288.txt"
#define BFILE_TEMP_NAME "b374288.txt.tmp"
