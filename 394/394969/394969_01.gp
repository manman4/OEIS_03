...
\\ 確認用
a = {[1,4,81,4384,447745,73207683,17470684441,
 5729487641704,2473348488736401,
 1360426574429100415,929288672122718278921,
 772139207530381095114510,
 767101638498346365209511841,
 898155767746311707477320951531,
 1224182783691628509836513104436025]};
...
print(Vec(exp(7 * x/(1 - 7^2*x) - 7*sum(i=1, #a, a[i]*x^i)) + O(x^10)));
print(Vec(exp(8 * x/(1 - 8^2*x) - 8*sum(i=1, #a, a[i]*x^i)) + O(x^10)));
print(Vec(exp(9 * x/(1 - 9^2*x) - 9*sum(i=1, #a, a[i]*x^i)) + O(x^10)));
