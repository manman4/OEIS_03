...
def a(n)
  ary = [1, 2, 8]
  (3..n).each{|i|
    ary << (8 * (1254*i**6 - 8481*i**5 + 21988*i**4 - 27874*i**3 + 18107*i**2 - 5672*i + 660) * ary[-1] - 16 * (i - 1) * (570*i**5 - 3570*i**4 + 8209*i**3 - 8451*i**2 + 3728*i - 540) * ary[-2] + 64 * (i - 2) * (i - 1) * (2*i - 5) * (57*i**3 - 129*i**2 + 76*i - 12) * ary[-3]) / (3*i * (3*i - 2) * (3*i - 1) * (57*i**3 - 300*i**2 + 505*i - 274))
  }
  ary
end
