/*
 * A395620 -- permutations whose prefix sums are never perfect squares.
 *
 * Count permutations s_1,...,s_n of [n] such that
 *
 *     Sum_{i=1..j} s_i is not a perfect square,   1 <= j <= n.
 *
 ...
 *
 *     dp[empty] = 1,
 *     dp[S] = 0                         if sum(S) is a perfect square,
 ...
 * checked explicitly.
 *
 * --upto writes a(0),...,a(MAX_N) to b395620_01.txt via a temporary .part
 ...
 *       395620_01.c -o 395620_01
 *
 * Usage:
 *   ./395620_01                 # save a(0)..a(27)
 *   ./395620_01 25
 *   ./395620_01 --upto 25
 *   ./395620_01 --term 25
 *   ./395620_01 --check
...
#error "395620_01.c requires unsigned __int128"
#endif

__extension__ typedef unsigned __int128 U128;

#define DEFAULT_MAX_N 27U
#define MAX_N 30U
...
#define BFILE_PATH "b395620_01.txt"
#define PART_PATH "b395620_01.txt.part"
...
static bool perfect_square[MAX_PREFIX_SUM + 1U];
                          ...
                          unsigned prefix_sum)
{
    ...
    for (unsigned value = 1U; value <= n; ++value) {
        ...
        if ((used & bit) != 0U || perfect_square[prefix_sum + value]) {
            continue;
        }
