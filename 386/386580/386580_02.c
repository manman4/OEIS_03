 ...
 *      386580_02.c -o 386580_02
 *   ./386580_02 [N]        # n = 0..N（既定 N = 100, 最大 127）
 *   ./386580_02 N --output FILE
 *   ./386580_02 N --no-bfile
 *
...
#error "386580_02.c requires unsigned __int128"
#endif
...
static const char *output_path = "b386580_02.txt";
...
int main(int argc, char **argv)
{
    ...
    for (int n = 0; n <= nmax; ++n) {
        const u128 value = build_layer(n);
        const u128 upper = n == 0 ? 1U : (u128)1U << (n - 1);
        if (value > upper)
