\\ A357394 E.g.f.: Series_Reversion( exp(-2*x) * log(1 + x) ).
\\ my(N=20, x='x+O('x^N)); concat(0, Vec(serlaplace(serreverse( exp(-2*x) * log(1 + x) ))))

\\ A357395 E.g.f.: Series_Reversion( exp(-3*x) * log(1 + x) ). 
...
\\ A357393 E.g.f.: Series_Reversion( exp(-4*x) * (exp(x) - 1) ). 
