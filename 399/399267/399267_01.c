 ...
 * that the finite search returns the true minimum.  The exceptional initial
 * values are a(0)=2 and a(1)=0.
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 399267_01.c \
 *       -o 399267_01 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./399267_01 --target 23 --verbose
 *   ./399267_01 --upto 100
 *   ./399267_01 --self-test 1000000
 */
...
#define BFILE_NAME "b399267.txt"
#define BFILE_TEMP_NAME "b399267.txt.tmp"
