/*
 * A399191: least k having exactly n positive solutions of
 *
 *                    x^2 + 4 y^2 = k.
 *
 ...
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 399191_01.c \
 *       -o 399191_01 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./399191_01 --target 23 --verbose
 *   ./399191_01 --upto 100
 *   ./399191_01 --self-test 1000000
 */
...
#define BFILE_NAME "b399191.txt"
#define BFILE_TEMP_NAME "b399191.txt.tmp"
