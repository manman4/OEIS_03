 ...
 *                         5 | a(n) for n > 0
 *
 * is used as an exact pruning rule. For n>=2, only assignments containing
 * the nonprincipal split prime 5 are retained. The initial value a(1)=0 is
 * handled separately, so the theorem guarantees that the true minimum is
 * never discarded.
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 399278_02.c \
 *       -o 399278_02 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./399278_02 --target 23 --verbose
 *   ./399278_02 --upto 100
 *   ./399278_02 --self-test 1000000
 */
...
#define BFILE_NAME "b399278_02.txt"
#define BFILE_TEMP_NAME "b399278_02.txt.tmp"
...
static void calculate_answer(uint64_t n, Answer *answer)
{
    ...
    search.require_multiple_of_five = n >= 2;
...
static void self_test(uint64_t limit)
{
    ...
    static const Regression known_regressions[] = {
        ...
        {21, 13234375}, {23, 3705625}, {24, 1730575}, {25, 33013750},
        {27, 4594975}, {28, 34890625}, {30, 9769375}, {32, 14620375},
        {36, 12114025}, {40, 43264375}
    };
    for (size_t i = 0;
