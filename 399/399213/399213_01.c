/*
 * A399213: least nonnegative k having exactly n positive-integer pairs
 * (x,y) satisfying
 *
 *                         x^2 + 8 y^2 = k.
 *
 ...
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 399213_01.c \
 *       -o 399213_01 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./399213_01 --target 23 --verbose
 *   ./399213_01 --upto 100
 *   ./399213_01 --self-test 1000000
 */
...
#define BFILE_NAME "b399213.txt"
#define BFILE_TEMP_NAME "b399213.txt.tmp"
