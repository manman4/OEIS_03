 ...
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 399274_01.c \
 *       -o 399274_01 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./399274_01 --target 23 --verbose
 *   ./399274_01 --upto 100
 *   ./399274_01 --self-test 1000000
 */
...
#define BFILE_NAME "b399274.txt"
#define BFILE_TEMP_NAME "b399274.txt.tmp"
