/*
 * A399215: least nonnegative k having exactly n positive-integer pairs
 * (x,y) satisfying
 *
 *                         x^2 + 6 y^2 = k.
 *
 ...
 *
 * Build:
 *   clang -O3 -std=c11 -Wall -Wextra -Wpedantic 399215_01.c \
 *       -o 399215_01 $(pkg-config --cflags --libs gmp)
 *
 * Examples:
 *   ./399215_01 --target 23 --verbose
 *   ./399215_01 --upto 100
 *   ./399215_01 --self-test 1000000
 */
...
#define BFILE_NAME "b399215.txt"
#define BFILE_TEMP_NAME "b399215.txt.tmp"
