...
\\ 確認用
a = [1, 6, 216, 18016, 2718575, 667151244, 249904389518, 136335045655680, 104258627494173747, 108236370325030253850, 148475074256982964816314, 263023328027145941803648512];
\\ exp( n^2*A(x) )*(1-n^3*x)
